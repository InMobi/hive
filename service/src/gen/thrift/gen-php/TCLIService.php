...
interface TCLIServiceIf {
  ...
  public function ExecuteStatementAsync(\TExecuteStatementAsyncReq $req);
...
class TCLIServiceClient implements \TCLIServiceIf {
  ...
  public function ExecuteStatementAsync(\TExecuteStatementAsyncReq $req)
  {
    $this->send_ExecuteStatementAsync($req);
    return $this->recv_ExecuteStatementAsync();
  }

  public function send_ExecuteStatementAsync(\TExecuteStatementAsyncReq $req)
  {
    $args = new \TCLIService_ExecuteStatementAsync_args();
    $args->req = $req;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'ExecuteStatementAsync', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('ExecuteStatementAsync', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_ExecuteStatementAsync()
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\TCLIService_ExecuteStatementAsync_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \TCLIService_ExecuteStatementAsync_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("ExecuteStatementAsync failed: unknown result");
  }
...
class TCLIService_ExecuteStatementAsync_args {
  ...
  public function getName() {
    return 'TCLIService_ExecuteStatementAsync_args';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->req = new \TExecuteStatementAsyncReq();
            $xfer += $this->req->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TCLIService_ExecuteStatementAsync_args');
    if ($this->req !== null) {
      if (!is_object($this->req)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class TCLIService_ExecuteStatementAsync_result {
  ...
  public function getName() {
    return 'TCLIService_ExecuteStatementAsync_result';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \TExecuteStatementAsyncResp();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TCLIService_ExecuteStatementAsync_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
