...
uint32_t TCLIService_ExecuteStatementAsync_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TCLIService_ExecuteStatementAsync_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("TCLIService_ExecuteStatementAsync_args");
...
uint32_t TCLIService_ExecuteStatementAsync_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("TCLIService_ExecuteStatementAsync_pargs");
...
uint32_t TCLIService_ExecuteStatementAsync_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TCLIService_ExecuteStatementAsync_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("TCLIService_ExecuteStatementAsync_result");
...
uint32_t TCLIService_ExecuteStatementAsync_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void TCLIServiceClient::ExecuteStatementAsync(TExecuteStatementAsyncResp& _return, const TExecuteStatementAsyncReq& req)
{
  send_ExecuteStatementAsync(req);
  recv_ExecuteStatementAsync(_return);
}

void TCLIServiceClient::send_ExecuteStatementAsync(const TExecuteStatementAsyncReq& req)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("ExecuteStatementAsync", ::apache::thrift::protocol::T_CALL, cseqid);

  TCLIService_ExecuteStatementAsync_pargs args;
  args.req = &req;
  args.write(oprot_);
...
void TCLIServiceClient::recv_ExecuteStatementAsync(TExecuteStatementAsyncResp& _return)
{
  ...
  if (fname.compare("ExecuteStatementAsync") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  TCLIService_ExecuteStatementAsync_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "ExecuteStatementAsync failed: unknown result");
}
...
void TCLIServiceProcessor::process_ExecuteStatementAsync(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TCLIService.ExecuteStatementAsync", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TCLIService.ExecuteStatementAsync");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "TCLIService.ExecuteStatementAsync");
  }

  TCLIService_ExecuteStatementAsync_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "TCLIService.ExecuteStatementAsync", bytes);
  }

  TCLIService_ExecuteStatementAsync_result result;
  try {
    iface_->ExecuteStatementAsync(result.success, args.req);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "TCLIService.ExecuteStatementAsync");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("ExecuteStatementAsync", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "TCLIService.ExecuteStatementAsync");
  }

  oprot->writeMessageBegin("ExecuteStatementAsync", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "TCLIService.ExecuteStatementAsync", bytes);
  }
}
...
void TCLIServiceProcessor::process_GetQueryPlan(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TCLIService.GetQueryPlan", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TCLIService.GetQueryPlan");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "TCLIService.GetQueryPlan");
  }
  ...
  TCLIService_GetQueryPlan_result result;
  try {
    iface_->GetQueryPlan(result.success, args.req);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "TCLIService.GetQueryPlan");
    }
