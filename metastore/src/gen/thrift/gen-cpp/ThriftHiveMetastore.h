...
typedef struct _ThriftHiveMetastore_get_num_partitions_by_filter_result__isset {
  _ThriftHiveMetastore_get_num_partitions_by_filter_result__isset() : success(false) {}
  bool success;
...
typedef struct _ThriftHiveMetastore_get_num_partitions_by_filter_presult__isset {
  _ThriftHiveMetastore_get_num_partitions_by_filter_presult__isset() : success(false) {}
  bool success;
